<?php
class ModuleCustom extends WP_Widget {

	public function __construct() {
		$id_base = 'module-custom';
		$name	= 'ModuleCustom';
		$widget_options = array(
					'classname' => 'module-custom',
					'description' => 'ModuleCustom'
				);
	...
	public function widget( $args, $instance ) {			
		...
		if($status_wrapper=="active"){
			...
			require PLUGIN_PATH . '/module/html/module-custom.php';		
			echo $after_widget;	
		}
		else
			require PLUGIN_PATH . '/module/html/module-custom.php';				
	...
	public function form( $instance ) {	
		...
		$class = array("widefat");
		$html		= $vHtml->label('Content',array('for'=>$inputID))
					  . $vHtml->cmsTextarea($inputID,$inputName,"widefat",$inputValue,10,60);
		echo $vHtml->pTag($html);	
